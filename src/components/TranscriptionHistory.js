    ...
    <>
      ...
      {isSidebarOpen && (
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-100 animate-fade-in" onClick={closeSidebar}>
          <div className="absolute top-0 right-0 w-full sm:w-[420px] lg:w-[480px] h-full bg-white/95 backdrop-blur-xl border-l border-white/30 shadow-2xl flex flex-col animate-slide-in-from-right" onClick={(e) => e.stopPropagation()}>
            {/* Sidebar Header */}
            <div className="p-4 sm:p-5 lg:p-6 border-b border-white/30 flex items-center justify-between bg-white/80">
              <div className="flex items-center gap-2 sm:gap-3 flex-1">
                <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor" className="text-indigo-500 sm:w-6 sm:h-6">
                  <path d="M13.5,8H12V13L16.28,15.54L17,14.33L13.5,12.25V8M13,3A9,9 0 0,0 4,12H1L4.96,16.03L9,12H6A7,7 0 0,1 13,5A7,7 0 0,1 20,12A7,7 0 0,1 13,19C11.07,19 9.32,18.21 8.06,16.94L6.64,18.36C8.27,20 10.5,21 13,21A9,9 0 0,0 22,12A9,9 0 0,0 13,3" />
                </svg>
                <h3 className="text-lg sm:text-xl font-bold text-gray-800 m-0">Transcription History</h3>
              ...
              <div className="flex gap-1.5 sm:gap-2">
                {history.length > 0 && (
                  <button
                    ...
                    className="p-1.5 sm:p-2 border-none rounded-md sm:rounded-lg cursor-pointer transition-all duration-300 flex items-center justify-center bg-red-50 text-red-500 hover:bg-red-100 hover:scale-110"
                ...
                <button
                  ...
                  className="p-1.5 sm:p-2 border-none rounded-md sm:rounded-lg cursor-pointer transition-all duration-300 flex items-center justify-center bg-gray-100 text-gray-600 hover:bg-gray-200 hover:scale-110"
                  title="Close sidebar"
                >
            ...
            <div className="flex-1 overflow-y-auto scrollbar-thin scrollbar-thumb-indigo-300 scrollbar-track-white/10">
              {history.length === 0 ? (
                <div className="flex flex-col items-center justify-center p-6 sm:p-8 lg:p-12 text-center text-gray-600">
                ...
                <div className="py-2 sm:py-3">
                  {history.map((item, index) => (
                    <div
                      key={item.id}
                      className="mx-2 sm:mx-3 mb-1.5 sm:mb-2 bg-white/70 rounded-lg sm:rounded-xl border border-white/30 transition-all duration-300 animate-slide-in-from-right hover:bg-white/90 hover:transform hover:-translate-x-1 hover:shadow-lg"
                      ...
                      <div className="p-3 sm:p-4">
                        <div className="flex items-start gap-2 sm:gap-3 mb-2 sm:mb-3">
                          ...
                          <div className="flex-1 min-w-0">
                            <h4 className="text-xs sm:text-sm font-semibold text-gray-800 m-0 mb-1 sm:mb-2 whitespace-nowrap overflow-hidden text-ellipsis" title={item.fileName}>
                              {item.fileName}
                            </h4>
                        ...
                        <div className="flex gap-1.5 sm:gap-2 justify-end">
                          ...
                          <button
                            ...
                            className="p-1.5 sm:p-2 border-none rounded-md cursor-pointer transition-all duration-300 flex items-center justify-center bg-red-50 text-red-500 hover:bg-red-100 hover:transform hover:-translate-y-1"
