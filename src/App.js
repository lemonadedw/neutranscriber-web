        ...
        {error && (
          <div className="my-8 p-4 bg-red-50 border border-red-200 rounded-xl animate-shake">
            ...
            <button
              ...
              className="bg-transparent border border-red-500 text-red-500 py-2 px-4 rounded-lg transition-all duration-300 hover:bg-red-50 cursor-pointer"
            >
              Try Again
            </button>
          </div>
        ...
        {result && result.status === 'SUCCESS' && (
          <div className="my-8 p-6 bg-green-50 border border-green-200 rounded-2xl animate-pulse-success">
            ...
            <div className="flex gap-3 justify-center flex-wrap">
              ...
              <button
                onClick={handleStartOver}
                className="bg-gradient-to-r from-gray-500 to-gray-600 text-white border-none py-3.5 px-7 text-base font-semibold rounded-xl cursor-pointer transition-all duration-300 hover:transform hover:-translate-y-1"
              >
                New Transcription
              </button>
            </div>
